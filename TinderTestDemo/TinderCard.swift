...
//  TinderTestDemo
//
//  Created by Govind Rakholiya on 17/04/18.
//  Copyright © 2018 test. All rights reserved.
//

let NAMES = ["Clara Smith","Sophie Laurak","Sagar Shah","Bob Thomas","John Harper","Sammie Lopez","George Stanley","Dominic Hope","Jay Jiang","Josephine Taylor","Taylor Thompson","Sam Gupta","Ronald Duck"]
let DESIGNATION = ["Django","Python","Django","React","React","Django","Django","Django","Django","Django","Django","React","Python"]
...
class TinderCard: UIView {
    ...
    func setupView(at value:String) {
        ...
        let RandomCount = Int(arc4random_uniform(UInt32(NAMES.count)))
        ...
        backGroundImageView.image = UIImage(named:String(RandomCount))
        ...
        let attributedText = NSMutableAttributedString(string: NAMES[RandomCount], attributes: [.foregroundColor: UIColor.white,.font:UIFont.boldSystemFont(ofSize: 25)])
        attributedText.append(NSAttributedString(string: "\n\(DESIGNATION[RandomCount]) ", attributes: [.foregroundColor: UIColor.white,.font:UIFont.systemFont(ofSize: 18)]))
